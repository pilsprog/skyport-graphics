...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14389 = (0);while(true){
if((i_14389 < arr.length))
{(arr[i_14389] = null);
{
...
{var i_14396 = (self__.level + (1));while(true){
if((i_14396 <= (new_level + (1))))
{(update[i_14396] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14398 = (0);while(true){
if((i_14398 <= self__.level))
{var links_14399 = (update[i_14398]).forward;if(((links_14399[i_14398]) === x__$1))
{(links_14399[i_14398] = (x__$1.forward[i_14398]));
{
var G__14400 = (i_14398 + (1));
i_14398 = G__14400;
continue;
}
} else
{{
var G__14401 = (i_14398 + (1));
i_14398 = G__14401;
continue;
}
}
