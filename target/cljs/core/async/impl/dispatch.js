...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14470 = (0);while(true){
var m_14471 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14471 == null))
{} else
{m_14471.call(null);
if((count_14470 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14472 = (count_14470 + (1));
count_14470 = G__14472;
continue;
}
} else
{}
