...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14476 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14476 = (function (val,box,meta14477){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14476.cljs$lang$type = true;
cljs.core.async.impl.channels.t14476.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14476";
cljs.core.async.impl.channels.t14476.cljs$lang$ctorPrWriter = (function (this__4110__auto__,writer__4111__auto__,opt__4112__auto__){return cljs.core._write.call(null,writer__4111__auto__,"cljs.core.async.impl.channels/t14476");
});
cljs.core.async.impl.channels.t14476.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14476.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14478){var self__ = this;
var _14478__$1 = this;return self__.meta14477;
});
cljs.core.async.impl.channels.t14476.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14478,meta14477__$1){var self__ = this;
var _14478__$1 = this;return (new cljs.core.async.impl.channels.t14476(self__.val,self__.box,meta14477__$1));
});
cljs.core.async.impl.channels.__GT_t14476 = (function __GT_t14476(val__$1,box__$1,meta14477){return (new cljs.core.async.impl.channels.t14476(val__$1,box__$1,meta14477));
});
}
return (new cljs.core.async.impl.channels.t14476(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14479 = self__.takes.pop();if((taker_14479 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14479))
{var take_cb_14480 = cljs.core.async.impl.protocols.commit.call(null,taker_14479);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14480,taker_14479,this$__$1){
return (function (){return take_cb_14480.call(null,null);
});})(take_cb_14480,taker_14479,this$__$1))
);
} else
{}
{
...
var putter_14481 = self__.puts.pop();if(!((putter_14481 == null)))
{var put_handler_14482 = putter_14481.handler;var val_14483 = putter_14481.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_14482))
{var put_cb_14484 = cljs.core.async.impl.protocols.commit.call(null,put_handler_14482);var __14485__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_14484,__14485__$1,put_handler_14482,val_14483,putter_14481,_,retval,this$__$1){
return (function (){return put_cb_14484.call(null,true);
});})(put_cb_14484,__14485__$1,put_handler_14482,val_14483,putter_14481,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_14483);
} else
{{
continue;
}
